...
void Shap::myAbout()
{
	...
	outtextxy(100, 200, _T("版本号: 4.32"));
	outtextxy(100, 250, _T("完成时间: 2019年6月初"));
	outtextxy(100, 300, _T("班级: 软工1809班"));
	outtextxy(100, 350, _T("学号: 8002118244"));
	outtextxy(50, 400, _T("操作说明:"));
	outtextxy(100, 450, _T("A 或者 ← 向左移动"));
	outtextxy(350, 450, _T("W 或者 ↑ 翻转方块"));
	outtextxy(100, 500, _T("D 或者 → 向右移动"));
	outtextxy(350, 500, _T("S 或者 ↓ 向下移动"));
	outtextxy(100, 550, _T("P 暂停键,暂停状态下再次按下 P 键，恢复游戏"));
	outtextxy(100, 600, _T("B  返回键"));
	settextcolor(0xFF5555);
	settextstyle(30, 25, _T("宋体"), 0, 0, FW_EXTRABOLD, false, false, false);
	outtextxy(240, 660, _T("返回"));
	...
	{
		m = GetMouseMsg();
		if (m.x > 240 && m.x < 340 && m.y > 660 && m.y < 690)
		{
			setfillcolor(0x55FF55);
			solidcircle(200, 675, 20);
			solidcircle(380, 675, 20);
			if (m.uMsg == WM_LBUTTONUP) {
				break;
			}
		}
